...
class SQLite: IDatabase {
    ...
    private val host = HostSQLite(File(PlumBot.INSTANCE.config!!.getStringFromConfig("database", "sqlite", "path")!!.replace("%plugin_folder%", PlumBot.INSTANCE.dataDirectory.pathString)))
